...
#' @param Cumulative.T Incurred cost triangle.
...
DevFactors_Net_Incurred=function(RNN_DevFactors,RNN_DevYear,Cumulative.T,OutliersControl){
  ...
  if(OutliersControl==1){out=ifelse(out<0.975,OutCL,out)}
