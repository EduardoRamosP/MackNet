...
#' @param Control Development factors below 0.975 are not allowed when this variable is set to 1. Additionally, deviations from tradional Chain Ladder model are under control.
...
#Macknet model for paid data
MackNet_Paid=function(Cumulative.T,Incurred.T,Exposure,EarlyStoppingPatience=50,Epochs=1000,MinimumEpochs=700,
  ...
  MackNet_1 = MackNet_Fit(Cumulative.T,Incurred.T,Exposure,AR,Ensemble,wd,Learning,drop,Epochs,MinimumEpochs,ES,Output)
  ...
  MackNet_3 = MackNet_Boot(Simulations,MackNet_2,Cumulative.T,Control)
